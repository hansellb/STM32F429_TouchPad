...
#define USBD_VID                     	0x0483	// Same as 1155
#define USBD_PID                     	0x5710  // Example from had 22315 which is 0x572B and IS NOT a valid PID

#define USBD_LANGID_STRING            	0x409	// Same as 1033
